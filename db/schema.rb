...
ActiveRecord::Schema[7.0].define(version: 2022_11_17_154753) do
  ...
  create_table "expense_groups", force: :cascade do |t|
    ...
    t.index ["expense_id", "group_id"], name: "index_expense_groups_on_expense_id_and_group_id"
    t.index ["group_id", "expense_id"], name: "index_expense_groups_on_group_id_and_expense_id"
  end
  ...
  create_table "income_groups", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["group_id", "income_id"], name: "index_income_groups_on_group_id_and_income_id"
    t.index ["income_id", "group_id"], name: "index_income_groups_on_income_id_and_group_id"
  end
  ...
  create_table "incomes", force: :cascade do |t|
    ...
    t.string "description", default: "Description", null: false
    t.integer "amount", default: 0, null: false
    t.string "icon", default: "https://img.icons8.com/external-flatart-icons-lineal-color-flatarticons/64/null/external-income-startup-flatart-icons-lineal-color-flatarticons.png", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
